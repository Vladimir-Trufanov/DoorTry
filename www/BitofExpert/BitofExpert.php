 ...
 *  
 *  2025-02-26 Zip-файлы. На сервере все zip-файлы размещаются в каталоге корня 
 *  "zip". Во всех ссылках из md-файлов на эти zip-ы должен указываться префикс 
 *  "../zip/", а файлы размещаться в соответствующих подкаталогах.
 * 
 */
...
require_once "ReplaceHrefPdf.php";
...
function MakeImgWidth40($FileContent)
{
   $aimwidth62=array
   (
      'Cache-memory-mode.jpg',
   );
   $FileContent=MakeImgWidth($FileContent,62,$aimwidth62);
