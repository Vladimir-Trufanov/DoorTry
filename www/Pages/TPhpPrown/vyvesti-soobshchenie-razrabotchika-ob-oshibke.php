<?php
// PHP7               *** vyvesti-soobshchenie-razrabotchika-ob-oshibke.php ***
...
define ("Script", "vyvesti-soobshchenie-razrabotchika-ob-oshibke"); 
...
"MakeUserError выводит сообщение разработчика об ошибке в одном из четырех режимов: 
1) просто выводится сообщение в текущей позиции сайта (как правило, при тестировании);
2) вызывается исключение с пользовательским сообщением (режим принимается по умолчанию);
3) формируется дополнительный блок для сообщениемя с идентификатором 'Ers';
4) разворачивается сообщение в диалоговом окне с помощью JQueryUI">
<meta name="keywords" content=
"MakeUserError, вывести сообщение разработчика об ошибке или сформировать исключение, принцип DO-or-TRY, делай или пробуй, TPhpPrown">
<?php
...
<h5><span class="letter">Ф</span>ункция MakeUserError выводит сообщение из разрабатываемого программного модуля при возникновении ошибочной ситуации. Информационное сообщение об этом выводится в одном из четырёх режимов:</h5>
...
<h5><span class="letter">Ф</span>ункция MakeUserError выделяет два вида ошибок (контроллируемые и неконтроллируемые) и определяет их следующим образом:</h5>
